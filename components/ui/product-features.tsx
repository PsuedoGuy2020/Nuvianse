...
export function ProductFeatures() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Make image sticky when first feature appears and container is in view
      const shouldBeSticky = inView && containerTop <= headerHeight && containerBottom > viewportHeight
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/2 relative">
              <div 
                ...
                style={{
                  width: isSticky ? '50vw' : '100%',
                  maxWidth: isSticky ? '600px' : 'none',
                  right: isSticky ? 'max(2rem, calc((100vw - 1200px) / 2))' : 'auto',
                }}
              >
                {/* Background Glow Effect */}
                <div 
                  className={cn(
                    "absolute inset-0 rounded-2xl transition-all duration-700 blur-2xl -z-10",
                ...
                <div className="relative w-full h-full rounded-2xl overflow-hidden">
                  ...
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-blue-500/60 rounded-full animate-pulse" />
                  <div className="absolute -bottom-3 -left-3 w-4 h-4 bg-purple-500/40 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
                  <div className="absolute top-1/4 -right-4 w-3 h-3 bg-emerald-500/50 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
                </div>
